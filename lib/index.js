...
var Config = z.object({
  ...
  fontFamily: z.string().description("\u7EC8\u7AEF\u5B57\u4F53\u65CF\uFF08CSS font-family \u4E32\uFF09\uFF0C\u5982 \u2018Maple Mono NF CN\u2019, Consolas, monospace\u3002\u7559\u7A7A\u4F7F\u7528\u5185\u7F6E\u9ED8\u8BA4\u5B57\u4F53\u6808\uFF08\u542B CJK \u56DE\u9000\uFF09\uFF1BNerd Font / Powerline \u7528\u6237\u628A\u672C\u673A\u5B57\u4F53\u586B\u5728\u6700\u524D\u5373\u53EF\u6B63\u5E38\u663E\u793A\u56FE\u6807\u5B57\u5F62\u3002\u4EC5\u5E94\u7528\u4E8E\u65B0\u5EFA\u4F1A\u8BDD\u53CA\u5176\u91CD\u542F").default("").volatile(),
  fontSize: z.number().description("\u7EC8\u7AEF\u5B57\u53F7\uFF08\u50CF\u7D20\uFF09\u3002\u9ED8\u8BA4 12.5\u3002\u4EC5\u5E94\u7528\u4E8E\u65B0\u5EFA\u4F1A\u8BDD\u53CA\u5176\u91CD\u542F").default(DEFAULT_FONT_SIZE).volatile()
});
var name = PKG_NAME;
